...
const Header = () => {
  ...
  return (
   <header className='flex justify-between items-center p-4 border-b border-gray-200 max-w-6xl mx-auto'>
        <Link href="/" className='text-xl md:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent hover:from-purple-700 hover:via-pink-700 hover:to-blue-700 transition-all duration-300 cursor-pointer tracking-tight'>
            Blog App
        </Link>
